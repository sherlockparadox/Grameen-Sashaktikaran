...
<h1><center>List of Patients</center></h1><br>
<br>
<?php
$userid=$_SESSION['id'];
$sql3 = "SELECT * FROM citizen_details";
...
<td>
  <form method="POST" action="view.php">
    <input type="hidden" name="choose" value="<?php echo $row1['username']?>"/>
    <input class = "btn waves-effect waves-teal" type="submit" name="choos" value="View">
  </form>
